...
import { validacionPaciente, validacionPerfil } from '../middlewares/validacionPaciente.js'
...
router.put('/paciente/:id',verificarTokenJWT,validacionPerfil,actualizarPerfil)
